...
export async function loadRegistry(drive) {
  ...
  try {
    ...
    return {
      ...
      // ΚΡΙΣΙΜΟ: κοινό αρχείο μητρώου με την cloud. Πρέπει να ΔΙΑΒΑΖΟΝΤΑΙ και να
      // ΞΑΝΑΓΡΑΦΟΝΤΑΙ τα Δίκτυα Κειμένων — αλλιώς η light τα σβήνει σε κάθε αποθήκευση.
...
export async function saveRegistry(drive, registry) {
  const payload = {
    ...
    networks: registry.networks || [], // Δίκτυα Κειμένων — να ΔΙΑΤΗΡΟΥΝΤΑΙ, όχι να σβήνονται
  };
