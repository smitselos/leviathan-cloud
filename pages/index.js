                ...
                {!isMobile&&<div style={{position:'relative'}}>
                  ...
                  {showPrintMenu&&<div style={{position:'absolute',top:'100%',right:0,marginTop:'6px',background:'#fff',border:'1px solid #e0e0e0',borderRadius:'12px',boxShadow:'0 8px 24px rgba(0,0,0,0.12)',zIndex:20,minWidth:'240px',overflow:'hidden'}}>
                    ...
                    <button onClick={()=>{
                      ...
                      const w=window.open('','_blank');
                      w.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>${modalFile.title} — Κανονική</title><style>*{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11pt;line-height:1.2;color:#1a1a1a;} .page{max-width:800px;margin:0 auto;padding:40px 32px;} h1{font-size:14pt;font-weight:700;margin-bottom:4px;} .sub{font-size:9pt;color:#888;margin-bottom:24px;} iframe{width:100%;height:85vh;border:1px solid #ddd;border-radius:8px;} .questions-page{page-break-before:always;padding-top:40px;} h2{font-size:12pt;font-weight:700;margin-bottom:8px;border-bottom:1.5px solid #c0c0c0;padding-bottom:6px;} .qtitle{font-size:9pt;color:#888;margin-bottom:16px;} .q-item{margin-bottom:2em;font-size:11pt;line-height:1.2;} .q-code{font-weight:700;} .actions{display:flex;gap:10px;margin-top:24px;} @media print{.no-print{display:none!important;} iframe{height:auto;min-height:85vh;} .questions-page{page-break-before:always;}}</style></head><body><div class="page"><h1>${modalFile.title}</h1><p class="sub">${modalFile.name}</p><iframe src="/api/files/pdf/${modalFile.id}"></iframe><div class="questions-page"><h2>Ερωτήσεις</h2><p class="qtitle">${modalFile.title}</p>${qHtml}</div><div class="actions no-print"><button onclick="window.print()" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;background:#1a1a1a;color:#fff;border:none;padding:10px 24px;border-radius:10px;font-size:11pt;cursor:pointer">🖨️ Εκτύπωση</button></div></div></body></html>`);
                      w.document.close();
                      setShowPrintMenu(false);
                    }}
